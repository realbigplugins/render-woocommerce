...
module.exports = function (grunt) {
    ...
    var pkg = grunt.file.readJSON('package.json'),
        ...
        text_domain = 'Render_WooCommerce';
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            src: {
                files: {
                    'src/assets/js/render-woocommerce.min.js': ['src/assets/js/source/**/*.js', '!src/assets/js/source/admin/**/*.js']
                }
            },
            admin: {
                files: {
                    'src/assets/js/render-woocommerce-admin.min.js': ['src/assets/js/source/admin/*.js']
                }
            }
        },
        ...
        sass: {
            ...
            src: {
                files: {
                    'src/assets/css/render-woocommerce.min.css': 'src/assets/scss/main.scss'
                }
            },
            admin: {
                files: {
                    'src/assets/css/render-woocommerce-admin.min.css': 'src/assets/scss/admin/admin.scss'
                }
            }
        },
        ...
        'string-replace': {
            version: {
                ...
                options: {
                    replacements: [{
                        ...
                        pattern: /(define.*?RENDER_WOOCOMMERCE_VERSION.*?)\d\.\d\.\d/,
                        replacement: "$1" + pkg.version
                    }]
                }
            },
            header: {
                files: {
                    'build/render-woocommerce.php': ['build/render-woocommerce.php', '!' + image_ignore]
                },
                options: {
                    replacements: [{
                        pattern: /\/\/\{\{HEADER}}/,
